...
class NonactivatedFilter(admin.SimpleListFilter):
    """Фильтр пользователей по никам, именам и фамилиям, email.
    Вывод неактивированных пользователей в течение трех дней и недели, а также
    уже выполневших активацию.
     """
